...
interface ShadeSystemDropdownProps {
  onSelect?: (value: string) => void;
  selectedValue?: string;
}

export default function ShadeSystemDropdown({ onSelect, selectedValue }: ShadeSystemDropdownProps) {
  const options = ['VITA Lumin', 'VITApan 3D Master', 'Other'];
  
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative rounded-[4px] shadow-[0px_2px_6px_0px_rgba(0,0,0,0.15)] w-full max-h-[300px] overflow-y-auto" data-name="ShadeSystemDropdown">
