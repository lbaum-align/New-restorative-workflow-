    ...
    return (
      <div className="px-4 py-3 border-t border-[#e5e7eb] shrink-0">
        <div className="flex items-center gap-2 mb-1.5">
          ...
          <span className="text-[11px] text-[#64748b]">Analyzing...</span>
        </div>
    ...
    <div className="px-4 py-3 border-t border-[#e5e7eb] shrink-0">
      {nextView && nextAvailable ? (
        <button
          ...
          className="w-full py-2 px-3 rounded-md bg-[#009ACE] text-white text-[12px] font-medium hover:bg-[#0088B8] active:scale-[0.98] transition-all"
        >
          Next: {NEXT_LABELS[activeView]}
        </button>
      ) : allComplete && !nextView ? (
        <div className="text-center text-[11px] text-[#00964E] font-medium py-1">
          Analysis complete
        </div>
      ) : (
        <div className="text-center text-[11px] text-[#94a3b8] py-1">
