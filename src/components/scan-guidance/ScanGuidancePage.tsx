        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: space[2] }}>
          <button
            ...
            style={{
              ...
              padding: `5px 12px`,
              backgroundColor: showArrows ? color.primary : color.neutral100,
              color: showArrows ? '#fff' : color.textSubtle,
              border: `1px solid ${showArrows ? color.primary : color.borderDefault}`,
