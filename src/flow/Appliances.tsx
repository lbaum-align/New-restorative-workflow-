...
export default function Appliances({
  ...
  const [currentProcedure, setCurrentProcedure] = useState("Appliances");
    ...
    <div className="min-h-screen bg-[#f9f9f9] flex flex-col">
      ...
      <div className="flex-1 flex flex-col px-[46px] pt-[52px] pb-[80px] overflow-y-auto">
        <div className="flex flex-col gap-[24px] w-full pb-[40px]">
          ...
          <div className="flex gap-[16px] w-full items-stretch -mt-[20px] h-[80px]">
            {/* Back Button + Procedure Container */}
            <div className="flex gap-[16px] items-stretch h-full">
              {/* Back Button */}
          ...
          <div className="flex gap-[20px] w-full items-start">
            <div className="flex-1">
              <Rx variant="appliance" />
            </div>
          </div>

          {/* Attachments and Notes Container - Horizontal Layout, Always Expanded */}
