...
function Group() {
  return (
    <div className="absolute contents inset-0">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgGroup1} />
    </div>
  );
}
...
function Group4() {
  return (
    <div className="absolute contents inset-0">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgGroup2} />
    </div>
  );
}
...
export default function BiteModel() {
  return (
    <div className="relative size-full" data-name="Bite model">
      <Group2 />
    </div>
  );
}