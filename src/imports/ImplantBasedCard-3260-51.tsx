import svgPaths from "./svg-aa4au84kc1";
    ...
    <div className="bg-[#eef9fd] relative rounded-[8px] size-full" data-name="Implant based card">
      <div className="content-stretch flex flex-col gap-[12px] items-center overflow-clip pt-[12px] relative rounded-[inherit] size-full">
        ...
        <div className="bg-white content-stretch flex flex-col h-[80px] items-start py-[8px] relative shrink-0 w-full">
          ...
          <div className="absolute left-[215px] overflow-clip size-[32px] top-[44px]" data-name="Edit">
            <div className="absolute inset-[6.25%_6.25%_12.5%_6.25%]" data-name="Vector">
              <svg className="absolute block inset-0" fill="none" preserveAspectRatio="none" viewBox="0 0 28 26">
                <g id="Vector">
                  ...
                  <path d={svgPaths.p83df200} fill="#0067AC" />
                </g>
              </svg>
            </div>
          </div>
        </div>
        <div className="absolute left-[215px] overflow-clip size-[32px] top-[4px]" data-name="Star fill">
          <div className="absolute inset-[6.25%_4%]" data-name="Shape">
            <svg className="absolute block inset-0" fill="none" preserveAspectRatio="none" viewBox="0 0 29.44 28">
              <path d={svgPaths.p15f2e300} fill="var(--fill-0, #00ADEF)" id="Shape" />
            </svg>
          </div>
        </div>
      </div>
