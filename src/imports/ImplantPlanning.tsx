  ...
  return (
    <div className="relative shrink-0 size-[52px]" data-name="Chevron left">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 52 52">
        <g id="Chevron left">
          <path d={svgPaths.p3ae4e0f2} fill="var(--fill-0, #696A6D)" id="Vector" opacity="0" />
        </g>
      </svg>
    </div>
  );
...
function Frame25() {
  return (
    <div className="content-stretch flex items-center justify-end relative shrink-0 w-[483px]">
      <Edit />
    </div>
  );
}
...
function RxPatientHeaderUpdated() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-0 pl-[4px] pr-[40px] py-[24px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.1),0px_2px_8px_0px_rgba(0,0,0,0.15)] top-[68px] w-[1920px]" data-name="Rx / Patient header - updated">
      <Frame17 />
      <Frame25 />
    </div>
  );
...
function Dropdown() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[882px]" data-name="Dropdown">
      <Field />
    </div>
  );
}
...
function FieldRow() {
  return (
    <div className="content-stretch flex gap-[48px] h-[78px] items-start pb-0 pt-[10px] px-0 relative shrink-0" data-name="Field row">
      <Dropdown />
    </div>
  );
}
...
function Procedures() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-start p-[24px] relative rounded-[8px] shrink-0 w-[1860px]" data-name="Procedures">
      <div aria-hidden="true" className="absolute border border-[#e0e0e0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <p className="font-['Roboto:Medium',sans-serif] font-medium leading-[30px] min-w-full relative shrink-0 text-[24px] text-black w-[min-content]" dir="auto" style={{ fontVariationSettings: "'wdth' 100" }}>
        Implant planning
      </p>
      <FieldRow />
    </div>
...
function Rx() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[87px] items-start justify-center p-[24px] relative rounded-[8px] shrink-0 w-[1860px]" data-name="Rx">
      <div aria-hidden="true" className="absolute border border-[#e0e0e0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Frame18 />
    </div>
  );
...
function RecordsNotesRecordsLarge() {
  return (
    <div className="bg-white h-[317px] relative rounded-[8px] shrink-0 w-[920px]" data-name="Records + Notes/Records/Large">
      <div className="content-stretch flex flex-col gap-[24px] items-start overflow-clip px-[28px] py-[32px] relative rounded-[inherit] size-full">
...
function RxElementsRecordsNotesLayers3() {
  return (
    <div className="bg-white h-[317px] relative rounded-[8px] shrink-0 w-[920px]" data-name="Rx elements (records, notes, layers)">
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-col h-[317px] items-start relative shrink-0">
      <Frame14 />
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="content-stretch flex flex-col h-[317px] items-end relative shrink-0 w-full">
      <Frame12 />
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-1/2 top-[226px] translate-x-[-50%] w-[1860px]">
      <Frame29 />
      <Procedures />
      <Rx />
      <Frame13 />
...
function Group17() {
  return (
    <div className="absolute inset-[45.67%_56.93%_53.65%_36.27%]">
      <div className="absolute inset-[-99.94%_-10%_-99.88%_-10%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 2">
          <g id="Group 3032">
...
function Path4() {
  return (
    <div className="absolute bottom-[31.56%] left-[29.2%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-7.632px_-2.083px] mask-size-[37.733px_35.361px] right-[31.85%] top-1/4" data-name="Path 4144" style={{ maskImage: `url('${imgPath4141}')` }}>
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 27">
        <g id="Path 4144">
...
export default function ImplantPlanning() {
  return (
    <div className="bg-[#e9e9e9] relative size-full" data-name="Implant planning">
      <div className="relative size-full">
        ...
        <Frame28 />
        <div className="absolute bg-[#868686] h-[493px] left-[1901px] rounded-[20px] top-[212px] w-[9px]" />
      </div>
