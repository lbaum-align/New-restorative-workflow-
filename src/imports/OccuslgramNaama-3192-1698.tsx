import svgPaths from "./svg-q8rul3fajh";
...
function Button() {
  return (
    <div className="absolute bg-[#bfeafb] content-stretch flex gap-[12px] h-[48px] items-center justify-center left-0 min-w-[108px] px-[16px] py-[22px] rounded-[4px] top-0" data-name="Button">
      ...
      <div className="flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#0067ac] text-[18px] text-center tracking-[0.2px] whitespace-nowrap" style={{ fontVariationSettings: "\'wdth\' 100" }}>
        <p className="leading-[28px]">0.55 - 1.45</p>
      </div>
    </div>
  );
}
