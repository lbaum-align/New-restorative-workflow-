import svgPaths from "./svg-tzbbognuvs";

function ChevronLeft() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Chevron left">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Chevron left">
          <path d={svgPaths.p2dd5ae40} fill="var(--fill-0, #3E3D40)" id="Vector" />
        </g>
      </svg>
    </div>
  );
