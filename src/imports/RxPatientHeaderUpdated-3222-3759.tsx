import svgPaths from "./svg-s5vw63ns8g";
...
function Frame12() {
  return (
    <div className="content-stretch flex gap-[60px] h-full items-center relative shrink-0">
      <div className="flex h-0 items-center justify-center relative self-center shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "153" } as React.CSSProperties}>
