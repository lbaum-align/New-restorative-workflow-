import svgPaths from "./svg-o0npxtgl4f";
...
function TrimArea1() {
  return (
    <div className="absolute h-[35.218px] left-1/2 top-[calc(50%+1.39px)] translate-x-[-50%] translate-y-[-50%] w-[50px]" data-name="trim area">
      <div className="absolute inset-[-2.75%_0_0_0]">
...
function Group1() {
  return (
    <div className="absolute contents inset-[-16.67%_0_41.09%_42.47%]" data-name="Group">
      <div className="absolute flex inset-[-16.67%_0_41.09%_42.47%] items-center justify-center">
...
function TrimArea2() {
  return (
    <div className="absolute bottom-[-9.68%] left-1/2 top-[-9.68%] translate-x-[-50%] w-[50px]" data-name="trim area">
      <div className="absolute inset-[-2.64%_0_0_0]">
...
function Group2() {
  return (
    <div className="absolute inset-[0_0_-0.09%_0]" data-name="Group">
...
function Layer1() {
  return (
    <div className="absolute contents inset-[0_0_-0.09%_0]" data-name="Layer 1">
      <Group2 />
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="absolute h-[38px] left-1/2 top-[calc(50%-0.1px)] translate-x-[-50%] translate-y-[-50%] w-[50px]">
      ...
      <div className="absolute inset-[47.37%_0_0_0]" data-name="Vector">
...
function Frame7() {
  return (
    <div className="bg-white content-stretch flex flex-col h-full items-center justify-center relative rounded-bl-[12px] rounded-br-[12px] w-[76px]">
      ...
      <div className="flex items-center justify-center relative shrink-0 size-[32px]" style={{ "--transform-inner-width": "300", "--transform-inner-height": "150" } as React.CSSProperties}>
