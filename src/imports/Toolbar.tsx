import svgPaths from "./svg-88qi54abaa";
...
function IconGroup() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Icon Group">
...
function ButtonContainer() {
  return (
    <div className="bg-white content-stretch flex flex-col h-full items-center justify-center relative rounded-bl-[12px] rounded-br-[12px] w-[76px]" data-name="Button Container">
      ...
      <div className="flex items-center justify-center relative shrink-0 size-[60px]" style={{ "--transform-inner-width": "300", "--transform-inner-height": "150" } as React.CSSProperties}>
...
function Container() {
  return (
    <div className="content-stretch flex gap-[8px] items-start justify-center relative shrink-0 w-[288px]" data-name="Container">
      <IconGroup />
      <div className="flex items-center justify-center relative self-stretch shrink-0 w-[68px]" style={{ "--transform-inner-width": "300", "--transform-inner-height": "150" } as React.CSSProperties}>
...
export default function Toolbar() {
  return (
    <div className="bg-white relative rounded-[8px] size-full" data-name="Toolbar">
