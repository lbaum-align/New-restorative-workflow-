import svgPaths from "./svg-twgkb7b6p3";
    ...
    <div className="absolute inset-[3.92%_32.76%_4.9%_32.74%]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21 93">
        <g id="Group 1583">
          ...
          <path d={svgPaths.p216ab700} fill="url(#paint0_linear_98_29561)" id="Path 2548" />
          <g id="Group 1582">
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_98_29561" x1="-8017.9" x2="-8017.9" y1="58.1746" y2="5.00409">
