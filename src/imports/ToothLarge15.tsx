...
export default function ToothLarge15() {
  return (
    <div className="relative w-[58px] h-[93px]" data-name="Tooth 15">
      ...
      <div className="absolute inset-[0_25.89%_0.54%_25.83%]" data-name="Stroke Path">
        <div className="absolute inset-[-1.18%_-2.63%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 95">
            <path d={svgPaths.p1a157e80} stroke="var(--stroke-0, #7AABCC)" strokeLinejoin="round" strokeWidth="2" fill="none" />
          </svg>
        </div>
      </div>
    </div>
