    ...
    <div className="absolute contents inset-[0_25.89%_0.54%_25.83%]">
      ...
      <div className="absolute inset-[0_25.89%_0.54%_25.83%]" data-name="Path 2611">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 95">
          <path d={svgPaths.p1a157e80} fill="var(--fill-0, #00ADEF)" id="Path 2611" />
        </svg>
      </div>
    </div>
  );
  ...
  return (
    <div className="absolute inset-[58.64%_24.93%_0_24.87%]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 40">
        <g id="Group 1642">
          <path d={svgPaths.p1aef4f00} fill="var(--fill-0, #00ADEF)" id="Path 2612" />
        </g>
      </svg>
    </div>
  );
...
export default function ToothLarge15Selected() {
  return (
    <div className="border-2 border-[#00ADEF] border-dashed relative rounded-[18px] w-[58px] h-[93px]" data-name="Tooth 15 Selected">
      <div className="relative size-full" data-name="Tooth 15">
        ...
        <Group8 />
        <div className="absolute inset-[0_25.89%_0.54%_25.83%]" data-name="Stroke Path">
          <div className="absolute inset-[-1.18%_-2.63%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 95">
              <path d={svgPaths.p1a157e80} stroke="var(--stroke-0, #00ADEF)" strokeLinejoin="round" strokeWidth="2" fill="none" />
            </svg>
          </div>
        </div>
      </div>
