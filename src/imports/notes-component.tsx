...
export default function Notes({
  ...
  return (
    <div className="bg-white relative rounded-[8px] w-full h-[380px] flex flex-col z-10" data-name="Notes">
      {/* Header */}
      ...
      <div className="px-[24px] pt-[4px] pb-[24px] shrink-0 relative z-20">
        <div className="relative h-[80px] bg-white rounded-[4px] border border-[#f0f0f0] flex items-center">
          <textarea
            value={currentNote}
            onChange={(e) => setCurrentNote(e.target.value)}
            placeholder="Add your note here..."
            className="w-full h-full resize-none bg-transparent p-[16px] pr-[76px] outline-none font-['Roboto:Regular',sans-serif] font-normal leading-[28px] text-[#3e3d40] text-[18px] placeholder:text-[#939598] focus:border-[#5fcefa] transition-colors relative z-10"
            style={{ fontVariationSettings: "'wdth' 100" }}
            onKeyDown={(e) => {
